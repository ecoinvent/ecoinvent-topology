...
no_duplicate_admin = "select * from (select count(*) c, admin from ne_countries group by admin) as t1 where t1.c > 1"
...
check_command(no_duplicate_a3_codes, "Duplicate admin codes", "Admin codes are all unique")
