...
+------------------------------------------+---------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
| All ecoinvent except for countries       | `GeoJSON <http://geography.ecoinvent.org/report/files/all-ecoinvent.geojson.bz2>`__   | `Geopackage <http://geography.ecoinvent.org/report/files/all-ecoinvent.gpkg>`__   | `KMZ <http://geography.ecoinvent.org/report/files/all-ecoinvent.kmz>`__   | `ESRI Shapefile <http://geography.ecoinvent.org/report/files/all-ecoinvent.zip>`__         |
+------------------------------------------+---------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
