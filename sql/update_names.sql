...
UPDATE ne_countries SET name = 'Congo' where name = 'Republic of Congo';
...
UPDATE ne_countries SET name = 'Aland' where name = 'Åland';
UPDATE ne_provinces SET name = 'Australia, Ashmore and Cartier Islands' where name = 'Ashmore and Cartier Islands';
...
UPDATE ne_countries SET name = 'Northern Cyprus' WHERE name = 'N. Cyprus';
UPDATE ne_countries SET name = 'Micronesia, Federated States of' WHERE name = 'Micronesia';
COMMIT;
